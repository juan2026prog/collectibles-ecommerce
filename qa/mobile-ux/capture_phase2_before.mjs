...
const BEFORE_DIR = path.resolve(__dirname, 'phase2-before');
...
async function captureScreenshots() {
  ...
  console.log(`Starting Phase 2 BEFORE capture from ${BASE_URL}...`);
  ...
  await browser.close();
  console.log(`\nPhase 2 BEFORE capture complete. Files saved to: ${BEFORE_DIR}`);
}
