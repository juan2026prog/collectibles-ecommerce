-- ============================================================================
-- SCRIPT DE PAUSA DE EMERGENCIA: ML IMPORT WORKER CRON
-- PROYECTO: Collectibles2026 (https://collectibles.uy)
-- ============================================================================

-- 1. Estado inicial del job ml-import-queue-process
SELECT 
    jobid, 
    jobname, 
    schedule, 
...
--     job_id := (SELECT jobid FROM cron.job WHERE jobname = 'ml-import-queue-process'), 
--     active := true
-- );
-- ============================================================================
