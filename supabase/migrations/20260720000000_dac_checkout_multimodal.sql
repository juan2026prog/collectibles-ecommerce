-- Migration: Support DAC Multimodal Checkout (dac_home, dac_agency)
-- Updates: public.create_order_atomic to recognize new shipping methods, and seeds default settings for delivery_providers
...
-- Update the DAC provider settings with delivery mode default codes
UPDATE public.delivery_providers
SET settings = settings || '{"entrega_domicilio": 1, "entrega_agencia": 2}'::jsonb
WHERE provider_key = 'dac';
