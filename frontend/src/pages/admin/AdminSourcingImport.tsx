...
export default function AdminSourcingImport() {
  ...
  return (
    <div className="space-y-5 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-white tracking-tight flex items-center gap-2.5">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-rose-500">
              SOURCING & IMPORTACIÓN
            </span>
          </h1>
          <p className="text-xs text-gray-400 mt-1 font-medium">
            Selección multifuente · costos · margen · mercado Uruguay
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-xl bg-dark-800 hover:bg-dark-700 text-gray-300 hover:text-white border border-white/10 transition-colors shadow-sm"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold rounded-xl bg-primary-600 hover:bg-primary-500 text-white shadow-lg shadow-primary-600/30 transition-all hover:scale-105"
          >
      ...
      <div className="bg-dark-900 border border-white/10 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-md">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-gray-400">Research Pack Activo:</span>
            <strong className="text-sm font-bold text-white">{activePackTitle}</strong>
          </div>
          <div className="flex items-center gap-4 text-xs font-mono">
            ...
            {reviewCount > 0 && (
              <span className="text-amber-400 font-semibold">
                <strong>{reviewCount}</strong> revisar
              </span>
            )}
          </div>
        </div>
