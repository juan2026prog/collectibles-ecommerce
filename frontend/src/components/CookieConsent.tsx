  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] p-4 pb-safe sm:p-6 lg:p-8 pointer-events-none animate-slide-up">
      <div className="max-w-7xl mx-auto flex justify-center sm:justify-start lg:justify-end">
        <div className="glass  shadow-2xl p-6 sm:p-8 max-w-sm pointer-events-auto">
          <h3 className="font-extrabold text-xl text-white mb-2">Privacidad 🍪</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button onClick={handleDecline} className="btn-secondary flex-1 text-sm py-2.5 px-4 whitespace-nowrap bg-white/5 hover:bg-white/10 border-0">
              Solo Esenciales
            </button>
