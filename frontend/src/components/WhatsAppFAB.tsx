...
export default function WhatsAppFAB() {
  ...
  return (
    <div className={`fixed right-4 md:right-6 z-40 flex flex-col items-end gap-3 group/fab pb-[env(safe-area-inset-bottom,0px)] transition-all duration-300 ${
      isPDP ? 'bottom-24 lg:bottom-6' : 'bottom-20 md:bottom-6'
    }`}>
      {/* Tooltip bubble */}
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[#25D366] hover:bg-[#20b858] text-white rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_12px_40px_rgba(37,211,102,0.5)] transition-all duration-300 hover:scale-110"
