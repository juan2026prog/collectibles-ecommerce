...
const i18n: Record<Language, Record<string, string>> = {
  es: {
    ...
    'shop.sort.recommended': 'Recomendados',
    'shop.sort.newest': 'Más nuevos',
    'shop.sort.priceAsc': 'Precio: menor a mayor',
    'shop.sort.priceDesc': 'Precio: mayor a menor',
    'shop.sort.priceLow': 'Menor Precio',
    'shop.sort.priceHigh': 'Mayor Precio',
    'shop.sort.name': 'A-Z',
    'shop.emptyHint': 'Intenta ajustar tus filtros o buscar con otras palabras.',
    'shop.clearFilters': 'Limpiar Filtros',
    'shop.allBrands': 'Todas las marcas',
    'shop.priceRange': 'Rango de Precio',
    'shop.applyFilters': 'Aplicar Filtros',
    'shop.subtitle': 'Descubre piezas exclusivas, figuras de edición limitada y los mejores artículos para tu colección.',
    // Product
